    ...
    <div class="containers" __vuec__>
      ...
      <div class="close" @click="close">X</div>
        ...
        <div class="footersss">
          ...
          <div class="agree" @click="msgbox = true">
            <img src="./images/redyes.png" alt="redyes">
            <span>我已阅读并同意遵守本次<span style="color:red;">服务协议</span></span>
          </div>
        </div>
      </div>
      <div class="msgbox" v-if="msgbox">
        <div class="header">自由工程协作平台服务协议</div>
        <div class="content" v-html="txt">
        </div>
        <div class="footer" @click="msgbox = false">确定</div>
      </div>
  </div>
</template>
<script>
